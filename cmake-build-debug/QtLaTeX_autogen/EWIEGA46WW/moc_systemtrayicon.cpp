...
QT_MOC_LITERAL(1, 15, 19), // "signal_lang_refresh"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 27), // "slot_sys_tray_iconActivated"
QT_MOC_LITERAL(4, 64, 33), // "QSystemTrayIcon::ActivationRe..."
QT_MOC_LITERAL(5, 98, 6), // "reason"
QT_MOC_LITERAL(6, 105, 8), // "set_lang"
QT_MOC_LITERAL(7, 114, 8), // "QAction*"
QT_MOC_LITERAL(8, 123, 3) // "act"

    },
    "SystemTrayIcon\0signal_lang_refresh\0\0"
    "slot_sys_tray_iconActivated\0"
    "QSystemTrayIcon::ActivationReason\0"
    "reason\0set_lang\0QAction*\0act"
};
...
void SystemTrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_lang_refresh(); break;
        case 1: _t->slot_sys_tray_iconActivated((*reinterpret_cast< QSystemTrayIcon::ActivationReason(*)>(_a[1]))); break;
        case 2: _t->set_lang((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTrayIcon::signal_lang_refresh)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SystemTrayIcon::signal_lang_refresh()
{
