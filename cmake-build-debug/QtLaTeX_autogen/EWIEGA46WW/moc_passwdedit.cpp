...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_passwdEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_passwdEdit_t qt_meta_stringdata_passwdEdit = {
    {
QT_MOC_LITERAL(0, 0, 10), // "passwdEdit"
QT_MOC_LITERAL(1, 11, 12), // "passwdEditOk"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 17) // "on_btn_ok_clicked"

    },
    "passwdEdit\0passwdEditOk\0\0on_btn_ok_clicked"
};
...
void passwdEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<passwdEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->passwdEditOk(); break;
        ...
        {
            using _t = void (passwdEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&passwdEdit::passwdEditOk)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject passwdEdit::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_passwdEdit.data,
    qt_meta_data_passwdEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *passwdEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_passwdEdit.stringdata0))
